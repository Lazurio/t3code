...
describe("branding", () => {
  ...
  it("uses the opt-in hosted browser identity without changing desktop branding", async () => {
    vi.stubEnv("VITE_HOSTED_APP_NAME", "  Lazurio T3 Code  ");
    vi.stubEnv("VITE_DISTRIBUTION_RELEASE", "lazurio-v0.0.38-r1");
    vi.stubEnv("VITE_DISTRIBUTION_UPSTREAM_TAG", "v0.0.38");
    vi.stubEnv("VITE_DISTRIBUTION_UPSTREAM_BASE", "c0995d2eaf8ec787b3318ed1169ae266ed1529f8");
    ...
    expect(branding.DISTRIBUTION_RELEASE).toBe("lazurio-v0.0.38-r1");
    expect(branding.DISTRIBUTION_UPSTREAM_TAG).toBe("v0.0.38");
    expect(branding.DISTRIBUTION_UPSTREAM_BASE).toBe("c0995d2eaf8ec787b3318ed1169ae266ed1529f8");
  });
});
