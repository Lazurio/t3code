...
const configuredHostedAppName = import.meta.env.VITE_HOSTED_APP_NAME?.trim() || null;
export const WEB_DISTRIBUTION_NAME = injectedDesktopAppBranding ? null : configuredHostedAppName;
...
export const APP_DISPLAY_NAME =
  ...
  (configuredHostedAppName && HOSTED_APP_CHANNEL !== "nightly"
    ? configuredHostedAppName
