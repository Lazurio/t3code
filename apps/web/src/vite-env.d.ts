...
interface ImportMetaEnv {
  ...
  readonly VITE_HOSTED_APP_NAME: string;
  readonly VITE_DISTRIBUTION_RELEASE: string;
  readonly VITE_DISTRIBUTION_UPSTREAM_TAG: string;
  readonly VITE_DISTRIBUTION_UPSTREAM_BASE: string;
