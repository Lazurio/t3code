...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server accepts arbitrary files as provider context. Missing means that
      clients must retain their image-only behavior. */
  contextFileUploads: Schema.optionalKey(Schema.Boolean),
